...
// #14 Create a function called coderTest that takes in an object that is a person. It
// looks to see if the person’s name is Jeremy and then changes the person object to have a property
...
*/
function outside(temp, humid, cloud) { //outside=gross
	if (temp > 80 && humid > 40) {
